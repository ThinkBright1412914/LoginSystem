...
namespace LoginSystem.Migrations
{
    ...
    [Migration("20240703052519_Making nullable for activation code")]
    partial class Makingnullableforactivationcode
    {
            ...
            modelBuilder.Entity("LoginSystem.Model.UserInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ExpirationDate = new DateTime(2024, 7, 4, 11, 10, 18, 958, DateTimeKind.Local).AddTicks(1723),
                            IsActive = true,
