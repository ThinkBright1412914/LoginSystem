...
namespace LoginSystem.Migrations
{
    ...
    [Migration("20240728110131_Booking setup part 1")]
    partial class Bookingsetuppart1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LoginSystem.Domain.Model.Cinema", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LoginSystem.Domain.Model.SeatDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LoginSystem.Domain.Model.UserInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ExpirationDate = new DateTime(2024, 7, 29, 16, 46, 30, 948, DateTimeKind.Local).AddTicks(880),
                            IsActive = true,
            ...
            modelBuilder.Entity("LoginSystem.Domain.Model.Booking", b =>
                {
                    b.HasOne("LoginSystem.Domain.Model.SeatDetail", "SeatDetails")
                        .WithMany()
                        .HasForeignKey("SeatDetailsId")
            ...
            modelBuilder.Entity("LoginSystem.Domain.Model.Show", b =>
                {
                    b.HasOne("LoginSystem.Domain.Model.Cinema", "CinemaInfo")
                        .WithMany()
